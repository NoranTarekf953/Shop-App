...
class ProductsScreen extends StatelessWidget {
    ...
    return BlocConsumer<ShopCubit, ShopStates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
            ...
            builder: (context) =>
                productHomeBuilder(ShopCubit.get(context).homemodel, context,ShopCubit.get(context).catmodel),
  ...
  Widget productHomeBuilder(HomeModel? model, context,CategoryModel? categoryModel) {
          ...
          children: [
            ...
            Container(
              ...
              child: ListView.separated(
                  physics: const BouncingScrollPhysics(),
                  scrollDirection: Axis.horizontal,
                  itemBuilder: (context, index) => categoriesHomeItems(context,categoryModel.data.data[index]),
            ...
            GridView.count(
              ...
              children: List.generate(
                  ...
                  (index) =>
                      productItemBuilder(model.data.products[index], context)),
            )
          ],
        ),
      ),
  ...
  Widget categoriesHomeItems(
    context,
    CatDataDataModel model
  ) {
    return Stack(
